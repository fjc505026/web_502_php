...
<head>
        ...
        <link rel="stylesheet" href="/phpProject/format/mainpage.css">
...
<body class="bg-secondary" >
        ...
        <nav class="navbar navbar-expand-sm  bg-danger navbar-dark">
            <a class="navbar-brand" href="index.php">
                <img src="/phpProject/images/logo.png" alt="logo">          
            </a>
            <ul class="navbar-nav">
                <li class="nav-item">
                    <a class="nav-link" href="/phpProject/index.php"><b>HOME</b> </a>
                </li>
                <li class="nav-item">
                    <div class="dropdown">
                        ...
                        <div class="dropdown-menu gdropdown-menu-left bg-danger text-white">
                            <a class="dropdown-item nav-link" href="/phpProject/php/UnitEnrollment.php"><b>Unit Enrolment</b></a>
                            <a class="dropdown-item nav-link" href="/phpProject/php/UnitDetail.php"><b>Unit Handbook(Detail)</b></a>
                            <a class="dropdown-item nav-link" href="/phpProject/php/UnitMagmnt.php"><b>Unit Management</b></a>
                        </div>
                        </div>
                </li>
                <li class="nav-item">
